...
export default function Home() {
  ...
  const products = [{ n: 'test', d: 'Our \'test\' product is a cutting-edge solution designed to streamline processes and increase efficiency, featuring a user-friendly interface and advanced functionality that sets it apart from the competition. By leveraging this product, customers can achieve significant improvements in productivity and overall performance.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'test', d: 'The \'test\' product offers a unique combination of innovative features and exceptional value, providing customers with a reliable and cost-effective solution that meets their specific needs and exceeds their expectations, resulting in enhanced customer satisfaction and loyalty.', i: 'https://images.pexels.com/photos/5342564/pexels-photo-5342564.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'test', d: 'With its advanced technology and sleek design, the \'test\' product is an ideal choice for customers seeking a high-performance solution that can keep pace with their evolving requirements, offering a seamless user experience and unparalleled support.', i: 'https://images.pexels.com/photos/5342564/pexels-photo-5342564.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'test', d: 'Our \'test\' product is a specialized solution tailored to address the specific challenges faced by our customers, featuring a customized approach and expert support to ensure seamless integration and maximum benefits, resulting in improved efficiency and bottom-line results.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'test', d: 'The \'test\' product is a groundbreaking offering that sets new standards in our industry, boasting an impressive array of features and capabilities that empower customers to achieve their goals and stay ahead of the competition, while enjoying exceptional support and service from our dedicated team.', i: 'https://images.pexels.com/photos/16280923/pexels-photo-16280923.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Hello Test, we specialize in delivering innovative products that cater to the ever-evolving needs of our customers, driven by a passion for excellence and a commitment to quality. With a focus on building lasting relationships, we strive to make a meaningful impact in our industry. By leveraging cutting-edge technologies and a customer-centric approach, we aim to set new standards in our field.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">Our vision is to become a leading provider of exceptional products and services, renowned for our dedication to customer satisfaction and our relentless pursuit of innovation.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">Our mission is to design, develop, and deliver top-notch products that exceed our customers\' expectations, while fostering a culture of continuous improvement and teamwork.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">tets</h4>
                  <p className="text-sm text-on-surface-variant">At Hello Test, our first core value, \'tets\', represents our unwavering commitment to embracing challenges and finding creative solutions, driving us to push beyond boundaries and achieve exceptional results.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">test</h4>
                  <p className="text-sm text-on-surface-variant">Our second core value, \'test\', embodies our passion for delivering outstanding quality and ensuring that every product and service meets the highest standards of excellence, reflecting our dedication to customer satisfaction and loyalty.</p>
                </div>
              </div>
            </div>
